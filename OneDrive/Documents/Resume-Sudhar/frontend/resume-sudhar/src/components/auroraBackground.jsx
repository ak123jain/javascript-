...
//    return (
//      <div className="relative w-full bg-[#121212] text-white overflow-hidden pt-[120px] md:pt-[140px]">
//        {/* Aurora Effect */}
...
//        {/* Foreground Content */}
//        <div className="relative z-10 flex flex-col md:flex-row items-start justify-between px-8 md:px-16 min-h-[100vh] md:min-h-[110vh] gap-6">
//          {/* Text Section */}
//          <div className="max-w-2xl">
//            <p className="text-lg text-gray-300 mb-2">Best AI Resume Builder</p>
//            <h1 className="text-5xl font-bold tracking-wide text-white drop-shadow-lg mb-2">
//              RESUME SUDHAR
//            </h1>
//            {children}
...
export const AuroraBackground = ({ className, children }) => {
  return (
    <div className="relative w-full bg-[#121212] text-white overflow-hidden pt-[140px] md:pt-[160px]">
      ...
      {/* Foreground Content */}
      <div className="relative z-10 flex flex-col md:flex-row items-start justify-between px-10 md:px-20 min-h-[100vh] md:min-h-[110vh] gap-8">
        {/* Text Section */}
